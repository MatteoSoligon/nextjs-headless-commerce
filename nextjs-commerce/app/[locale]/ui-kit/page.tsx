            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex items-center gap-2">
                    <Checkbox id="cb-invalid-checked" aria-invalid="true" defaultChecked />
                    <Label htmlFor="cb-invalid-checked">Invalid Checked</Label>
                  </div>
                </div>
              </div>
            </div>
          ...
          <AccordionContent>
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <Text weight="medium">States</Text>
                <div className="flex items-center gap-6">
                  <RadioGroup defaultValue="disabled-checked" orientation="horizontal">
                    <div className="flex items-center gap-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Label htmlFor="radio-disabled-checked">Disabled Checked</Label>
                    </div>
                  </RadioGroup>
                  <RadioGroup defaultValue="invalid-checked" orientation="horizontal">
                    <div className="flex items-center gap-2">
                      <RadioGroupItem value="invalid" id="radio-invalid" aria-invalid="true" />
                      <Label htmlFor="radio-invalid">Invalid</Label>
                    </div>
                    <div className="flex items-center gap-2">
                      <RadioGroupItem value="invalid-checked" id="radio-invalid-checked" aria-invalid="true" />
                      <Label htmlFor="radio-invalid-checked">Invalid Checked</Label>
                    </div>
                  </RadioGroup>
                </div>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-6">
                  ...
                  <div className="flex items-center gap-2">
                    <Switch id="sw-invalid-checked" aria-invalid="true" defaultChecked />
                  ...
                  <Dialog>
                    ...
                    <DialogContent size="md">
                      <DialogHeader>
                        ...
                        <DialogDescription>
                          This is the default dialog size, suitable for most use
                          cases.
                        </DialogDescription>
                      </DialogHeader>
                      <div className="py-4">
                  ...
                  <Dialog>
                    ...
                    <DialogContent size="lg">
                      <DialogHeader>
                        ...
                        <DialogDescription>
                          A larger dialog for complex forms or detailed content.
                        </DialogDescription>
                      </DialogHeader>
                      <div className="py-4">
                        <Text size="sm">
